// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ICurrencyConverter.cs" company="Sitecore Corporation">
...
namespace Sitecore.Ecommerce.DomainModel.Currencies
{
  using Prices;
  ...
  public interface ICurrencyConverter<TTotals, TCurrency>
    ...
    where TCurrency : Currency
  {
    ...
    TTotals Convert(TTotals inputTotals, TCurrency outputCurrency);
    ...
    /// <returns>The output totals.</returns>
    TTotals Convert(TTotals inputTotals, decimal relativeExchangeRate);
  }
}