// --------------------------------------------------------------------------------------------------------------------
// <copyright file="CommunicationConfiguration.cs" company="Sitecore Corporation">
//   Copyright (c) Sitecore Corporation 1999-2015
// </copyright>
// <summary>
//   Defines the CommunicationConfiguration class.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace Sitecore.Ecommerce.Data.ModelConfiguration
{
  ...
  /// <summary>
  /// Defines the communication configuration class.
  /// </summary>
  public class CommunicationConfiguration : EntityTypeConfiguration<Communication>
  {
    ...
    public CommunicationConfiguration()
    {
      ...
      this.Property(p => p.ChannelCode).HasMaxLength(Constants.BigCodeFieldLength);
    }
  }
}