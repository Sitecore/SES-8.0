// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SitecoreQuerySearchProvider.cs" company="Sitecore Corporation">
//   Copyright (c) Sitecore Corporation 1999-2015
// </copyright>
// <summary>
//   Defines the SitecoreQuerySearchProvider type.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace Sitecore.Ecommerce.Search
{
  ...
  /// Defines the SitecoreQuerySearchProvider type.
  /// </summary>
  public class SitecoreQuerySearchProvider : DatabaseSearchProvider
  {
    /// <summary>
