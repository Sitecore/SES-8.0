// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MappingItemMatcher.cs" company="Sitecore Corporation">
//   Copyright (c) Sitecore Corporation 1999-2015
// </copyright>
// <summary>
//   Defines the mapping item matcher class.
//   Matches entity property with correspond storage field.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace Sitecore.Ecommerce.Data.Mapping
{
  ...
  /// Matches entity property with correspond storage field.
  /// </summary>
  public class MappingItemMatcher
  {
    /// <summary>
    /// Gets the list of field names to map with the source property name.
    /// </summary>
