// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ShipOrderProcessingStrategy.cs" company="Sitecore Corporation">
//   Copyright (c) Sitecore Corporation 1999-2015
// </copyright>
// <summary>
//   Defines the ShipOrderProcessingStrategy type.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace Sitecore.Ecommerce.Merchant.OrderManagement
{
  ...
  /// <summary>
  /// Defines the ship order processing strategy class.
  /// </summary>
  public class ShipOrderProcessingStrategy : OrderStateProcessingStrategy
  {
    /// <summary>
    ...
    internal override LogEntry GetLogEntry(Order order, string template, string result)
    {
      ...
      return new LogEntry
      {
        Details = new LogEntryDetails(template, "Not Shipped", "Shipped in full"),
        Action = string.Format(Constants.ProcessInFullAction, "Ship"),
