// -------------------------------------------------------------------------------------------
// <copyright file="ProcessQueryString.cs" company="Sitecore Corporation">
...
namespace Sitecore.Ecommerce.Analytics.Pipelines.StartTracking
{
  using Components;
  using Diagnostics;
  ...
  /// <summary>
  /// The process query string class.
  /// </summary>
  public class ProcessQueryString : StartTrackingProcessor
  {
    /// <summary>
